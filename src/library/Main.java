...
implements IMainListener {
    ...
    public void showGUI() {
        ...
        System.out.println("10. Scan Book");
    ...
    public void borrowBooks() {
    	System.out.println("1.1.	BorrowBooks");
    ...
    private void setupTestData() {
        ...
        // 3 New books for Damaged, lost, disposed scenarios
        book[15] = this.bookDAO.addBook("author16", "title16", "callNo16");
        book[16] = this.bookDAO.addBook("author17", "title17", "callNo17");
        book[17] = this.bookDAO.addBook("author18", "title18", "callNo18");
        ...
        // New scenario
        Member member7 = new Member("Louren", "LourenLast", "3456", "email@Louren.com",4);
        // Disposed
        
        
        i2 = 15;
        while (i2 < 18) {
            loan = this.loanDAO.createLoan(member7, book[i2]);
            this.loanDAO.commitLoan(loan);
            ++i2;
        }
        ...
        book[15].dispose();
        book[16].lose();
        book[17].returnBook(true);
        
        // Change book status
        bookDAO.setBookStatus(book[15]);
        bookDAO.setBookStatus(book[16]);
        bookDAO.setBookStatus(book[17]);
    }
